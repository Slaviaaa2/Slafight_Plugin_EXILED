...
public class FifthistPriest : CustomRole
{
    public override uint Id { get; set; } = 2;
    public override string Name { get; set; } = "F_Priest";
    public override string Description { get; set; } = "<color=#ff00fa>第五教会 司祭</color>\n非常に<color=#ff00fa>第五的</color>な存在の恩寵を受けた第五主義者。\n施設を占領せよ！";
    public override string CustomInfo { get; set; } = "<color=#ff00fa>FIFTHIST PRIEST - 第五教会 司祭</color>";
    ...
    {
        player.CustomInfo = "<color=magenta>FIFTHIST PRIEST - 第五教会 司祭</color>";
