...
[CustomItem(ItemType.KeycardMTFPrivate)]
public class KeycardOld_Cadet : CustomItem
{
    public override uint Id { get; set; } = 104;
    public override string Name { get; set; } = "機動部隊候補生キーカード";
    public override string Description { get; set; } = "説明無し";
    public override float Weight { get; set; } = 1f;
    public override ItemType Type { get; set; } = ItemType.KeycardMTFPrivate;
    public override SpawnProperties SpawnProperties { get; set; } = new();
    public override Vector3 Scale { get; set; } = new Vector3(1.25f, 1.25f, 1.25f);
    public string SchemName = "OldKeycard_MtfCadet";
