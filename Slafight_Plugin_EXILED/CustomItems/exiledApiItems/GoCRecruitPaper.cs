...
public class GoCRecruitPaper : CustomItem
{
    public override uint Id { get; set; } = 2019;
    public override string Name { get; set; } = "UNGOC一般工作員セット";
    public override string Description { get; set; } = "一般工作員一人分のアイテムが入っている。\nこれを使えば工作員を一人だけ増やせる。";
