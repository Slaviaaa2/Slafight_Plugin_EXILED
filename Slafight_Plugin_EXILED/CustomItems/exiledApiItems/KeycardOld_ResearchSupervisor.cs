...
public class KeycardOld_ResearchSupervisor : CustomItem
{
    public override uint Id { get; set; } = 107;
    public override string Name { get; set; } = "研究主任キーカード";
    ...
    public string SchemName = "OldKeycard_ResearchSupervisor";
