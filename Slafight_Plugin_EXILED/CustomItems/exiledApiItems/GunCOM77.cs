...
public class GunCOM77 : CustomWeapon
{
    public override uint Id { get; set; } = 2016;
    public override string Name { get; set; } = "COM-77";
    ...
    private void OnReload(ReloadingWeaponEventArgs ev)
    {
        if (!Check(ev.Item)) return;
        ev.Firearm.MagazineAmmo = 7;
        ev.IsAllowed = true;
    }
