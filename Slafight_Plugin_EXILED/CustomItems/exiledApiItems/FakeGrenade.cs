...
public class FakeGrenade : CustomGrenade
{
    public override uint Id { get; set; } = 700;
    public override string Name { get; set; } = "多目的グレネード";
    public override string Description { get; set; } = "様々な清掃やドア破壊等、多種多様な用途に使う特殊グレネード。\n人体等に被害はないらしい";
