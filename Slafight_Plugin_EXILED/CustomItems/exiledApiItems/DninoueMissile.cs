...
public class DninoueMissile : CustomKeycard
{
    public override uint Id { get; set; } = 55555;
    public override string Name { get; set; } = "にゃあ";
    public override string Description { get; set; } = "あああああああああああああああああああああああああああ";
    public override float Weight { get; set; } = 1f;
    public override ItemType Type { get; set; } = ItemType.KeycardCustomTaskForce;
    public override SpawnProperties SpawnProperties { get; set; } = new();
    public override string KeycardLabel { get; set; } = "ADMIN ULTIMATE TOOL";
    [YamlIgnore]
    public override Color32? KeycardLabelColor { get; set; } = new Color32(255,0,250,255);
    public override string KeycardName { get; set; } = "UwU. 55555";
    [YamlIgnore]
    ...
    private void StartMagicMissile(DroppingItemEventArgs ev)
    {
        if (Check(ev.Item))
        {
            ...
            try
            {
                schematicObject = ObjectSpawner.SpawnSchematic("YoungDevLikesUltimatePicture",startPos,ev.Player.CameraTransform.forward);
