...
public class KeycardOld_FacilityManager : CustomItem
{
    public override uint Id { get; set; } = 109;
    public override string Name { get; set; } = "施設管理者キーカード";
    ...
    public string SchemName = "OldKeycard_FacilityManager";
    ...
    private void AddSchem(PickupAddedEventArgs ev)
    {
        if (Check(ev.Pickup))
        {
            ...
            Timing.CallDelayed(0.01f, () =>
            {
                ...
                schematicObject.transform.localScale = new Vector3(1.45f, 5f, 1.45f);
