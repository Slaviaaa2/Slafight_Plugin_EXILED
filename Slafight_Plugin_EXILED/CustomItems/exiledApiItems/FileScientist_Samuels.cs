...
public class FileScientist_Samuels : CustomKeycard
{
    public override uint Id { get; set; } = 2035;
    public override string Name { get; set; } = "File-Scientist-Samuels";
    public override string Description { get; set; } = "";
    public override float Weight { get; set; } = 1f;
    public override ItemType Type { get; set; } = ItemType.KeycardCustomSite02;
    public override SpawnProperties SpawnProperties { get; set; } = new();
    public override string KeycardLabel { get; set; } = "File-Scientist-Samuels";
    [YamlIgnore]
    public override Color32? KeycardLabelColor { get; set; } = new Color32(255,255,255,255);
    public override string KeycardName { get; set; } = "To Christopher Samuels";
    [YamlIgnore]
