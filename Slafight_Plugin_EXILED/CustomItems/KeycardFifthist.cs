...
public class KeycardFifthist : CustomKeycard
{
    public override uint Id { get; set; } = 5;
    public override string Name { get; set; } = "第五教会 第五デバイス";
    public override string Description { get; set; } = "第五教会が目的を達成するために作られたアクセスデバイス。\n扉やゲートを第五することで施設に侵入する。";
    public override float Weight { get; set; } = 1f;
    public override ItemType Type { get; set; } = ItemType.KeycardCustomTaskForce;
    public override SpawnProperties SpawnProperties { get; set; } = new();
    public override string KeycardLabel { get; set; } = "第五教会 第五デバイス";
    [YamlIgnore]
    public override Color32? KeycardLabelColor { get; set; } = new Color32(255,0,250,255);
    public override string KeycardName { get; set; } = "Rsc. Fifth";
    [YamlIgnore]
