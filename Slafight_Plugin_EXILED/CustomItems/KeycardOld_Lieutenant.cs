...
[CustomItem(ItemType.KeycardMTFOperative)]
public class KeycardOld_Lieutenant : CustomItem
{
    public override uint Id { get; set; } = 105;
    public override string Name { get; set; } = "機動部隊副官キーカード";
    public override string Description { get; set; } = "説明無し";
    public override float Weight { get; set; } = 1f;
    public override ItemType Type { get; set; } = ItemType.KeycardMTFOperative;
    public override SpawnProperties SpawnProperties { get; set; } = new();
    public override Vector3 Scale { get; set; } = new Vector3(1.25f, 1.25f, 1.25f);
    public string SchemName = "OldKeycard_MtfLieutenant";
