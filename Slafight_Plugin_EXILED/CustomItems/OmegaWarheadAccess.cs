...
public class OmegaWarheadAccess : CustomItem
{
    public override uint Id { get; set; } = 2005;
    public override string Name { get; set; } = "<color=blue>OMEGA WARHEAD</color>アクセスパス";
    public override string Description { get; set; } = "<color=blue>OMEGA WARHEAD</color>サイロにアクセスできる使い捨てのカード。\n担当職員へ：間違ってもゲート解放に使わないように！";
    public override float Weight { get; set; } = 1f;
    public override ItemType Type { get; set; } = ItemType.SurfaceAccessPass;
