...
public class PlayingCard : CustomKeycard
{
    public override uint Id { get; set; } = 2003;
    public override string Name { get; set; } = "Playing Card";
    public override string Description { get; set; } = "ただのトランプ。何にも使えない";
    public override float Weight { get; set; } = 1f;
    public override ItemType Type { get; set; } = ItemType.KeycardCustomSite02;
    public override SpawnProperties SpawnProperties { get; set; } = new();
    public override string KeycardLabel { get; set; } = "Playing Card";
    [YamlIgnore]
    public override Color32? KeycardLabelColor { get; set; } = new Color32(255,255,255,255);
    public override string KeycardName { get; set; } = "Role. Joker";
    [YamlIgnore]
