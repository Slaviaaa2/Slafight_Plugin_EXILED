...
[CustomItem(ItemType.KeycardScientist)]
public class KeycardOld_Commander : CustomItem
{
    public override uint Id { get; set; } = 106;
    public override string Name { get; set; } = "機動部隊指揮官キーカード";
    ...
    public string SchemName = "OldKeycard_Scientist";
