...
public class ChaosInsurgencyRaid
{
    ...
    public void CIREvent()
    {
        ...
        {
            if (eventPID != Slafight_Plugin_EXILED.Plugin.Singleton.SpecialEventsHandler.EventPID) return;
            Exiled.API.Features.Cassie.MessageTranslated("pitch_.8 Successfully terminated Foundations Exiled.API.Features.Cassie System and putted New Insurgencys Exiled.API.Features.Cassie System . Exiled.API.Features.Cassie is now under delta command","<color=#00b7eb>財団のExiled.API.Features.Cassieシステム</color>の<color=red>終了</color>に成功。新たな<color=#228b22>インサージェンシーのExiled.API.Features.Cassieシステム</color>の導入も成功。<split> Exiled.API.Features.Cassieは今や<b><color=#228b22>DELTA COMMAND</color></b>の手中にある。",false,false);
