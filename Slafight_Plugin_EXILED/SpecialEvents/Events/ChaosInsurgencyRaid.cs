...
Exiled.API.Features.Cassie.MessageTranslated("$pitch_1.02 Danger Detected Unknown Forces in Gate A . Please Check $pitch_.2 .g4 .g1 .g2",
        ...
        Timing.CallDelayed(8f, () =>
        {
            ...
            Timing.CallDelayed(45f, () =>
            {
                ...
                Exiled.API.Features.Cassie.MessageTranslated("$pitch_.8 First Order of Delta Command . Turn off all facilitys . Accepted .",
                ...
                Exiled.API.Features.Cassie.MessageTranslated("$pitch_.8 All Agent . Work Time .",
                    ...
                    if (cicount != 0)
                    {
                        ...
                        */
                        ...
                        Timing.CallDelayed(15f, () =>
                        {
                            ...
                            Exiled.API.Features.Cassie.MessageTranslated("$pitch_.2 .g4 .g4 $pitch_1 $pitch_.75 BY ORDER OF DELTA COMMAND . THE DEAD MANS SEQUENCE AND SURFACE ATTACK PROTOCOL ACTIVATED . DETONATION IN TMINUS 145 SECONDS . PLEASE D .g4 IE .g6 .g3 .g4",
