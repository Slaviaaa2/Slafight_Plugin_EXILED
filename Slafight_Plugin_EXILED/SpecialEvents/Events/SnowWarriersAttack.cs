...
//Exiled.API.Features.Cassie.MessageTranslated("$pitch_1.02 Danger Detected Unknown Forces in Gate A . Please Check $pitch_.2 .g4 .g1 .g2","警告、不明な部隊がGate Aで検出されました。確認を",true);
        Exiled.API.Features.Cassie.MessageTranslated("$pitch_1.02 Danger Detected Unknown Organism in Gate A . Please Check $pitch_.2 .g4 .g1 .g2",
        ...
        Timing.CallDelayed(12f, () =>
        {
            ...
            Exiled.API.Features.Cassie.MessageTranslated("$pitch_.8 Successfully terminated Foundations Cassie System and putted New Division Cassie System . Cassie is now under us",
            ...
            Timing.CallDelayed(45f, () =>
            {
                ...
                Exiled.API.Features.Cassie.MessageTranslated("$pitch_.8 First Order . Light up all facility . Accepted .",
                    "<b><color=#ffffff>雪の帝王</color></b>の最初の指令：全施設のライトアップ ...承認",false);
                Timing.RunCoroutine(LightUpCoroutine());
                Timing.CallDelayed(8f, () =>
                {
                    Exiled.API.Features.Cassie.MessageTranslated("$pitch_.8 Next Order . Turn off Tesla Gates . Accepted .",
                    ...
                    Timing.CallDelayed(8f, () =>
                    {
                        ...
                        Exiled.API.Features.Cassie.MessageTranslated("$pitch_.8 All Division . Work Time .",
                            "戦士達よ、働く時間だ。",false);     
                    });
                });
                ...
                Timing.CallDelayed(testingDelayedInt, () =>
                {
                    ...
                    if (cicount != 0)
                    {
                        ...
                        */
                        Exiled.API.Features.Cassie.MessageTranslated("$pitch_.8 All Division Agents Tasks completed . Last Order . . $pitch_.75 Destroy the Facility . $pitch_.4 .g1 $pitch_.26 .g5 .g6 .g4 $pitch_2 .g1 $pitch_.75 Good by all anomalys and foundation personnels .",
                        ...
                        Timing.CallDelayed(15f, () =>
                        {
                            ...
                            Exiled.API.Features.Cassie.MessageTranslated("$pitch_.2 .g4 .g4 $pitch_1 $pitch_.75 BY ORDER OF DIVISION COMMAND . THE DEAD MANS SEQUENCE AND ATTACK PROTOCOL ACTIVATED . DETONATION IN TMINUS 145 SECONDS . PLEASE D .g4 IE .g6 .g3 .g4",
    ...
    {
        if (eventPIDglobal != Plugin.Singleton.SpecialEventsHandler.EventPID) return;
        if (teslaDisabled)
        {
    ...
    private IEnumerator<float> LightUpCoroutine()
    {
        for (;;)
        {
            if (eventPIDglobal != Plugin.Singleton.SpecialEventsHandler.EventPID) yield break;
            foreach (Room room in Room.List)
            {
                room.AreLightsOff = false;
