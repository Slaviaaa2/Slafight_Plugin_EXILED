...
public class SpawnSystem
{
    ...
    public void SummonForces(SpawnTypeId spawnType)
    {
        ...
        else if (spawnType == SpawnTypeId.MTF_HDNormal)
        {
            ...
            Cassie.MessageTranslated($"MtfUnit Nu 7 Designated {natoForce} {natoForceNum} HasEntered AllRemaining This Forces Work Epsilon 11 Task and operated by O5 Command . for Big Containment Breachs .",
